...
const [draftErrors, setDraftErrors] = useState<Record<string, string>>({});
  ...
  const [bankDetails, setBankDetails] = useState<BankDetailsData>(emptyBankDetails);
  ...
  const cityOptions = useMemo(() => {
    ...
    return City.getCitiesOfState(accountForm.countryCode, accountForm.stateCode).map(
      (c) => ({
        value: c.name,
        label: c.name,
      }),
...
const saveDraftRow = () => {
                ...
                <Listbox
                  ...
                  value={
                    parties.find((p) => p.id === partyId)
                      ? {
                          label: parties.find((p) => p.id === partyId)?.name || "",
                          value: partyId,
                        }
                      : null
                  }
  ...
  <tr>
    <th className="whitespace-nowrap px-3 py-2.5 text-center text-xs font-semibold text-gray-700 dark:text-gray-300">ITEM</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300">ITEM NAME</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300">ITEM CODE</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300">COLOR</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300">CHASSIS NO</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300">ENGINE NO</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-center text-xs font-semibold text-gray-700 dark:text-gray-300">QTY</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300">RATE PER</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-center text-xs font-semibold text-gray-700 dark:text-gray-300">GST %</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-right text-xs font-semibold text-gray-700 dark:text-gray-300">AMOUNT</th>
    <th className="whitespace-nowrap px-3 py-2.5 text-center text-xs font-semibold text-gray-700 dark:text-gray-300">ACTION</th>
  </tr>
</thead>
              <tbody>
                {/* Draft row */}
...
<tr className="bg-gray-50 dark:bg-gray-700/50">
  ...
  <td className="px-2 py-1.5 text-center">
    <button
      ...
      className={`inline-flex h-8 w-8 items-center justify-center rounded-lg text-white ${
        draft.item.trim() ? "bg-green-600 hover:bg-green-700" : "cursor-not-allowed bg-gray-300"
      }`}
    >
  ...
  <tr
    ...
    className={`border-t border-gray-200 dark:border-gray-700 ${
      index % 2 === 0 ? "bg-white dark:bg-gray-800/50" : "bg-gray-50 dark:bg-gray-700/30"
    }`}
  >
    <td className="px-3 py-2.5 text-center font-medium text-gray-500 dark:text-gray-400">{index + 1}</td>
    <td className="px-3 py-2.5 font-medium text-gray-900 dark:text-gray-200">{r.item}</td>
    <td className="px-3 py-2.5 text-gray-700 dark:text-gray-300">{r.itemCode}</td>
    ...
    <td className="px-3 py-2.5 font-mono text-gray-700 dark:text-gray-300">{r.chassisNo}</td>
    <td className="px-3 py-2.5 font-mono text-gray-700 dark:text-gray-300">{r.engineNo}</td>
    <td className="px-3 py-2.5 text-center font-semibold text-gray-900 dark:text-gray-200">{r.qty}</td>
    <td className="px-3 py-2.5 text-gray-700 dark:text-gray-300">{r.ratePer}</td>
    <td className="px-3 py-2.5 text-center text-gray-700 dark:text-gray-300">{r.gstPercent}%</td>
    <td className="px-3 py-2.5 text-right font-semibold text-gray-900 dark:text-gray-200">₹{r.amount}</td>
      ...
      >
        <XMarkIcon className="h-4 w-4" />
          ...
          <div className="mt-4 flex flex-col justify-between gap-2 border-t border-gray-200 pt-4 text-sm font-semibold text-gray-700 sm:flex-row dark:border-gray-700 dark:text-gray-300">
            <span>
              Total Quantity: <span className="font-bold text-gray-900 dark:text-white">{totalQuantity}</span>
            </span>
            <span>
              Total Amount: <span className="font-bold text-gray-900 dark:text-white">₹{fmt(totalAmount)}</span>
            </span>
          </div>
        </div>
    ...
    <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800/50">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-4 border-t border-gray-200 pt-4 dark:border-gray-700">
        ...
        <label className="flex cursor-pointer items-center gap-2 text-sm">
          ...
          />
          <span className="text-gray-600 dark:text-gray-400">Not Verify</span>
        </label>
        <label className="flex cursor-pointer items-center gap-2 text-sm">
          <Radio
          ...
          />
          <span className="text-gray-600 dark:text-gray-400">Verify</span>
        </label>
      </div>
    </div>
  </div>
  ...
  <div className="lg:col-span-2">
    <div className="rounded-lg border border-gray-200 bg-gradient-to-br from-blue-50 to-white p-4 shadow-sm dark:border-gray-700 dark:from-gray-800 dark:to-gray-800/50">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between border-b border-gray-200/60 pb-2 dark:border-gray-700/60">
          <span className="text-sm text-gray-600 dark:text-gray-400">New Taxable Value</span>
          <span className="text-sm font-semibold text-gray-800 dark:text-gray-200">
            ₹{fmt(newTaxableValue)}
          </span>
        </div>
      ...
      {vehicleModalOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          <div className="absolute inset-0 bg-black/50" onClick={() => { setVehicleModalOpen(false); setVehicleSearch(""); }} />
          <div className="absolute right-0 top-0 h-full w-full max-w-2xl transform bg-white shadow-2xl transition-transform dark:bg-gray-800 sm:w-3/4 lg:w-1/2">
            <div className="flex h-full flex-col">
              <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 sm:px-6 sm:py-4 dark:border-gray-700">
                <h2 className="text-lg font-bold text-blue-600 dark:text-blue-400"> Vehicle Details</h2>
                <button
                  onClick={() => { setVehicleModalOpen(false); setVehicleSearch(""); }}
      ...
      {bankDetailsModalOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          <div className="absolute inset-0 bg-black/50" onClick={handleCancelBankDetails} />
          <div className="absolute right-0 top-0 h-full w-full max-w-lg transform bg-white shadow-2xl transition-transform dark:bg-gray-800 sm:w-3/4 lg:w-2/5">
            <div className="flex h-full flex-col">
              <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 sm:px-6 sm:py-4 dark:border-gray-700">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white"> Bank Details</h2>
                <button
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-6">
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 sm:gap-3">
                    {paymentModeOptions.map((opt) => (
                      <label key={opt.value} className="flex cursor-pointer items-center gap-2 text-sm text-gray-800 dark:text-gray-200">
                        <input
                          type="radio"
                          name="paymentMode"
                  ...
                  <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateBankDetails("chequeNo", e.target.value)}
                    ...
                    <div className="sm:col-span-2">
                      <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Clear Date</label>
                      <DatePicker
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    onChange={(e) => updateBankDetails("narration", e.target.value)}
                    rows={3}
      ...
      {accountModalOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          <div className="absolute inset-0 bg-black/50" onClick={() => { setAccountModalOpen(false); setAccountForm(emptyAccount); setAccountTouched(false); }} />
          <div className="absolute right-0 top-0 h-full w-full max-w-2xl transform bg-white shadow-2xl transition-transform dark:bg-gray-800 sm:w-3/4 lg:w-1/2">
            <div className="flex h-full flex-col">
              <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 sm:px-6 sm:py-4 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                  ...
                  <div>
                    ...
                    {accountTouched && !accountForm.countryCode && (
                      <p className="mt-1 text-xs text-red-500">Please select a country.</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {accountTouched && !accountForm.district && (
                      <p className="mt-1 text-xs text-red-500">Please select a district.</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {accountTouched && !accountForm.city && (
                      <p className="mt-1 text-xs text-red-500">Please select a city.</p>
                    )}
                  </div>
